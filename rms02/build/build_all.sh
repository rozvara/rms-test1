...
inofile="rms02.ino" # hlavní soubor projektu
...
#        /tmp/rmsbuild/build/v15.ino.hex
        #echo Zpatky OK $result >> "$logfile"
    else
        echo
        #echo Zpatky mame ERR $result >> "$logfile"
    fi

    # #     HEX_SOURCE="./build/output.hex"
    # #     HEX_DEST="${FW_VERSION}${FW_TAG}_${MCU}.hex"
    # #     echo $HEX_DEST
